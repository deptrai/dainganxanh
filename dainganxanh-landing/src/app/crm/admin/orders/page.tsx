...
export default function OrdersPage() {
    const { orders, loading, error, filters, setFilters, pagination, setPage, approveOrder, refetch } = useAdminOrders()
    ...
    return (
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <>
                    <OrderTable orders={orders} approveOrder={approveOrder} />
