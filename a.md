...
- **Acceptance Criteria:**
  ...
  - And 1-click share to Facebook
- **Dependencies:** Canvas API for image generation, Facebook SDK
...
- **Acceptance Criteria:**
  ...
  - Then generate unique ref code: agawood.vn/ref/{code}
...
- **Acceptance Criteria:**
  ...
  - When user clicks "Share Facebook"
  - Then open Facebook share dialog with pre-filled:
    - Text: "Tôi vừa trồng X cây cho Mẹ Thiên Nhiên 🌳"
    - Image: Generated share card
    - Link: Landing page + ref code
- **Dependencies:** Facebook SDK, OG tags
...
- **Acceptance Criteria:**
  ...
  And I should see "Chia sẻ lên Facebook" button
  When I click share button
  Then Facebook dialog opens with pre-populated text and image
  ```
- **Dependencies:** FR-06, Canvas API, Facebook SDK
- **Story Points:** 8
...
- **Acceptance Criteria:**
  ...
  And email should contain:
    ...
    - Link to dashboard: agawood.vn/dashboard
